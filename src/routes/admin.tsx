    ...
    <AppShell>
      <div className="p-6 max-w-[1600px] mx-auto">
        ...
        <div className="mt-6">
          ...
          {tab === "content" && <ContentLibraryTab canApprove={role === "admin"} />}
...
function OverviewTab() {
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-2">
      <SectionCard title="Help Management" description="Library health across every registered area" icon={LifeBuoy} context="admin-help-mgmt-card">
      ...
      <SectionCard title="Ticket Management" description="Support requests raised from the help panel" icon={TicketIcon} context="admin-ticket-mgmt-card">
        <div className="grid sm:grid-cols-2 gap-3">
          <StatCard
      ...
      <SectionCard title="Activity" description="Help views and ticket volume over the last 12 weeks" icon={BarChart3} context="admin-graph-view">
      ...
      <SectionCard title="Coverage" description="How much of the application has published help" icon={Library} context="admin-coverage-card">
        <div className="grid sm:grid-cols-2 gap-3">
      ...
      <SectionCard title="User Management" description="Workspace roles (read-only in this release)" icon={Users} context="admin-user-mgmt-card">
